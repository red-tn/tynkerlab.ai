    ...
    <div className="min-h-screen flex items-center justify-center relative z-[1] px-4">
      <div className="w-full max-w-md space-y-8">
        <div className="text-center">
          ...
          <p className="text-gray-400 mt-2">Sign in to your Tynkerlab.ai account</p>
        </div>
        ...
        <div className="bg-nyx-surface border border-nyx-border rounded-xl p-6 space-y-6">
          <form onSubmit={handleLogin} className="space-y-4">
            ...
            <div className="flex justify-end">
              <Link href="/reset-password" className="text-sm text-primary-400 hover:text-primary-300">
                Forgot password?
              </Link>
            </div>
          ...
          <div className="relative">
            ...
            <div className="relative flex justify-center text-xs">
              <span className="px-2 bg-nyx-surface text-gray-500">Or continue with</span>
            </div>
          </div>
